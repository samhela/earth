...
<%@include file="../header.jsp"%>
		...
		<%@include file="../sideBar.jsp"%>
			...
			<table class="table table-hover">
	    		...
	    		<tbody>
			 <c:forEach items="${courseOfferings}" var="course">
					<tr>
						<td>${course.courseOfferingId}</td>
			...
			<div>
		 	...
		 	<div class="well">
		 		<a href="<c:url value='/course/courseList' />">Back to Course</a>
		 	</div>
